...
class AStarPlanner:
    ...
    def calc_final_path(self, goal_node, closed_set):
        ...
        while parent_index != -1:
            ...
            path.append((self.calc_grid_position(n.x, self.min_x),
    ...
    def get_motion_model():
        ...
        return motion
    def format_points(self, x_values, y_values):
        return list(zip(x_values, y_values))

def main():
    print(__file__ + " start!!")
    print("Start " + __file__)
    # file_path = 'boundary2.txt'q
    file_path = '/media/vaibhav/0a93e228-fc47-4044-b542-4ddd3464b0bb/home/vaibhav/graic_ws/Race/boundary2.txt'

    # This will store the tuples.
    obstacle_list = [(85, 100.0),
                    (85, 99.5),
                    (85, 99.0),
                    (85, 98.5),
                    (85, 98.0),
